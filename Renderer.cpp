...
Renderer::Renderer(GameObject* owner)
	: Component(owner), currentSprite(nullptr), alpha(1.0f), initialized(false)
{
}

Renderer::Renderer(GameObject* owner, Sprite* startSprite, float alpha)
	: Component(owner), currentSprite(startSprite), alpha(alpha), initialized(true)
{
}
